# Generated by Powerlevel10k configuration wizard on 2020-01-31 at 15:41 CST.
...
() {
  ...
  # Regular expression for the network interface name from which LAN IP is extracted.
  # Type `ifconfig || ip -4 a show` to see all available network interfaces.
